...
logistic的梯度求解公式推导可见gradient_logistic_step.ipynb文件，或者点击这个链接 [梯度求解步骤](http://localhost:8892/notebooks/Downloads/book/islr/logistic/gradient_logisitc_step.ipynb)。   
> 本文档部分代码参考自《机器学习实战》.
