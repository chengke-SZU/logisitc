...
all_methods_pe = function(x, y){
  ...
  t.newtonRapshon = system.time({newtonRapshon_weight = newtonRapshon(x, y)})[3]
  ...
  re_time = c(t.glm, t.gradAscent, t.stocGradAscent, t.stocGradAscent1, t.optimFun, t.newtonRapshon)
  names(re_time) = c("glm", "gradAscent", "stocGradAscent", "stocGradAscent1", "optimFun", "newtonRapshon")
  
  re_mse = c(glm_mse, gradAscent_mse, stocGradAscent_mse, stocGradAscent1_mse, optimFun_mse, newtonRapshon_mse)
  names(re_mse) = c("glm_mse", "gradAscent", "stocGradAscent", "stocGradAscent1", "optimFun", "newtonRapshon")
  
  re_rate = c(glm_rate, gradAscent_rate, stocGradAscent_rate, stocGradAscent1_rate, optimFun_rate, newtonRapshon_rate)
  names(re_rate) = c("glm", "gradAscent", "stocGradAscent", "stocGradAscent1", "optimFun", "newtonRapshon")
